...
import { getAllFeedback, Feedback } from "@/lib/supabase/feedback";
import { Skeleton } from "../ui/skeleton";
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from "@/components/ui/card";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { Button } from "../ui/button";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
import { Check, X, Circle, Edit, Save, Loader2, Users, MessageSquare } from "lucide-react";
            ...
            <main className="flex-1 space-y-6 p-4 sm:p-6 lg:p-8">
                ...
                <Tabs defaultValue="feeManagement">
                    <TabsList className="grid grid-cols-2 w-full max-w-md mx-auto">
                        ...
                        <TabsTrigger value="complaints">Complaints ({feeComplaints.length})</TabsTrigger>
                    </TabsList>
                    <TabsContent value="feeManagement" className="mt-6">
                        <Card>
                            <CardHeader>
                     ...
                     <TabsContent value="complaints" className="mt-6">
                         <Card>
                             <CardHeader>
                                 <CardTitle className="flex items-center gap-2"><MessageSquare />Fee-Related Complaints</CardTitle>
                                 <CardDescription>Review and address complaints related to fees submitted by students and teachers.</CardDescription>
                             </CardHeader>
                             <CardContent>
                                <ApproveLeaves leaves={feeComplaints} title="Fees" isPrincipal={true} />
                             </CardContent>
                         </Card>
                     </TabsContent>
                </Tabs>
