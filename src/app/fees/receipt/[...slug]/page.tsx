...
function ReceiptPageContent() {
    ...
    const receiptNo = `FEE-${session?.replace('-', '')}-${month?.toUpperCase()}-${student?.srn || '0000'}`;
    ...
    return (
        <div className="bg-muted/40 p-4 sm:p-8 print:p-0">
            <div className="mx-auto max-w-2xl">
                ...
                <div className="bg-card p-6 sm:p-10 shadow-lg print:shadow-none relative z-10 border rounded-lg">
